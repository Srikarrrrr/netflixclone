        ...
        <div className='max-w-[450px] h-[600px] mx-auto bg-black/75 text-white'>
            <div className='max-w-[320px] mx-auto py-16'>
                ...
                <form className='w-full flex flex-col py-4' onSubmit={handleSubmit}>
                    <input onChange={(e) =>setEmail(e.target.value)} className='p-3 my-2 border border-gray-600 bg-transparent backdrop-blur-sm rounded' type='email' placeholder='Email' autoComplete='email'/>
